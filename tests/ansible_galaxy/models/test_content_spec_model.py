...
def test_init():
    cs = repository_spec.ContentSpec(namespace='ns',
                                  name='n',
                                  version='3.4.5')

    assert isinstance(cs, repository_spec.ContentSpec)
...
def test_hash():
    cs1 = repository_spec.ContentSpec(namespace='cs1',
                                   name='cs1',
                                   version='3.4.5')

    cs1a = repository_spec.ContentSpec(namespace='cs1',
                                    name='cs1',
                                    version='3.4.5')

    cs2 = repository_spec.ContentSpec(namespace='cs2',
                                   name='c2',
                                   version='3.4.2')
...
def test_equal():
    cs1 = repository_spec.ContentSpec(namespace='ns',
                                   name='n',
                                   version='3.4.5')

    cs1a = repository_spec.ContentSpec(namespace='ns',
                                    name='n',
                                    version='3.4.5')

    cs2 = repository_spec.ContentSpec(namespace='ns2',
                                   name='n2',
                                   version='3.4.2')
